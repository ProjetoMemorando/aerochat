...
✈︎ Marcação de assento: Custo adicional, exceto durante o check-in, onde é gratuita (de 48 horas a 1 hora antes do voo).
✈︎ Remarcação (Mudança de data): Para alterar a data do voo, você pagará o valor de R$ 400,00 ou 100% do preço original da passagem, prevalecendo o menor entre os dois, se a nova passagem tiver um valor superior, será necessário cobrir a diferença de preço.
...
✈︎ Remarcação (Mudança de data): Para alterar, você pagará R$ 370,00 ou 100% do valor da passagem, o que for mais barato. Se a nova passagem for mais cara, também será necessário pagar a diferença de preço.
...
Dimensões máximas permitidas: 55 cm de altura, 35 cm de largura e 25 cm de profundidade.
        `
        ,
...
As datas da viagem (ida e volta) devem estar dentro de 7 dias a partir da data do falecimento;
A solicitação deve ser feita em até 7 dias após o falecimento; 
A solicitação deve ser feita após a realização do voo; 
A passagem deve ter sido adquirida diretamente com a GOL.
 
✈️ Regras para envio de documentos:
Aceitos apenas arquivos digitalizados em PDF, PNG ou JPEG, com imagem fiel ao original;
Não serão aceitas cópias (xerox), documentos com rasuras, baixa qualidade ou inconsistências;
Declarações de união estável devem ser comprovadas por escritura pública emitida por autoridade civil nacional;
Em reservas com múltiplos passageiros, o benefício será concedido apenas ao passageiro com vínculo familiar comprovado.
 
⚠️ Fotografias dos documentos serão aceitas, desde que sejam do documento original e estejam perfeitamente legíveis.
...
Nesse momento, o titular do cartão utilizado na compra deverá estar presente, portando um documento de identificação. Caso isso não seja possível, será necessário seguir as orientações fornecidas no aeroporto.
    ...
    agencia: [ ` XXXX, no atendimento da GOL, alguns procedimentos relacionados a reservas emitidas por agências, como alterações, cancelamentos ou correção de nome, são tratados diretamente pela própria agência responsável pela emissão.
...
Para dar continuidade à sua solicitação, oriento que entre em contato com a agência onde a compra foi realizada. Caso necessário, a agência poderá acionar os canais da GOL destinados ao atendimento de reservas de agência.
    ...
    agente: [ ` XXXX, entendi sua solicitação. Por este canal, atendemos reservas emitidas diretamente pela GOL, não sendo possível realizar procedimentos em reservas feitas por agências de viagem.
