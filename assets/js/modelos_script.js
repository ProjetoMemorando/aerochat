...
let modelos_scripts = {
    script_inicial: [
        ...
        '(Nome do cliente), gostaria de iniciar informando o número do protocolo que foi gerado para este atendimento: XXXXX, daremos início à decolagem. Como posso te ajudar?'
    ],
