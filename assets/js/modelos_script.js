...
let modelos_scripts = {
    script_inicial: [
        ...
        ,
        `(Nome do cliente), gostaria de iniciar informando o número do protocolo que foi gerado para este atendimento: XXXXX. Agora que seu cartão de embarque já foi apresentado, daremos início à decolagem. Como posso te ajudar?`
    ],
...
function titulos(value) {
    ...
    let lista_titulos = {
        acordo_de_espera: '⚠ Em hipótese alguma você pode ficar mais de 2 minutos sem enviar mensagem para o cliente. Utilize o script abaixo para renovar o acordo de espera. ⚠',
